...
export class LokLokWiggleSimulation {
  constructor({ skinData, node, renderer, howManyTracker = 10, howLongTail = 32, influences }) {
    ...
    let matLine0 = new ShaderMaterial({
      ...
      vertexShader: /* glsl */ `
        ...
        void main (void) {
          ...
          vec2 volume = vec2(2.5 * snip) * 0.05;
...
export class FunSim {
  constructor({ skinData, node, cursorPointer, howManyTrackers = 8, influences, tailLength = 64 }) {
    this.influences = influences
