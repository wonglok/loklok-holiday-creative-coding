    ...
    let matLine0 = new ShaderMaterial({
      ...
      vertexShader: /* glsl */ `
        ...
        void main (void) {
          ...
          vec2 volume = vec2(snip) * 0.035 * 0.02 + pow(t, 3.0) * pow(1.0 - t, 1.0) * 0.02;
...
class NoodleGeo {
  constructor(props) {
    ...
    let origPosArray0 = origPosArray.map((r) => 0)
    lineGeo.setAttribute('position', new BufferAttribute(origPosArray0, 3))
    lineGeo.setAttribute('oPosition', new BufferAttribute(origPosArray, 3))
