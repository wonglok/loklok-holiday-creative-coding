...
export class NoodleGeo {
  constructor(props) {
    ...
    lineGeo.setAttribute('position', new BufferAttribute(new Float32Array(oPositions0Data), 3))
    lineGeo.setAttribute('dataposition', new BufferAttribute(origPosArray, 3))
